...
func (m *ClusterServiceUpdateProjectClusterBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterServiceUpdateProjectClusterBody) validateSpec(formats strfmt.Registry) error {
...
func (m *ClusterServiceUpdateProjectClusterBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterServiceUpdateProjectClusterBody) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClusterServiceUpdateProjectClusterBody) UnmarshalBinary(b []byte) error {
	var res ClusterServiceUpdateProjectClusterBody
