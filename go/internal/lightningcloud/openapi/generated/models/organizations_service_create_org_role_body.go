...
func (m *OrganizationsServiceCreateOrgRoleBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrganizationsServiceCreateOrgRoleBody) validateRules(formats strfmt.Registry) error {
...
func (m *OrganizationsServiceCreateOrgRoleBody) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrganizationsServiceCreateOrgRoleBody) UnmarshalBinary(b []byte) error {
	var res OrganizationsServiceCreateOrgRoleBody
