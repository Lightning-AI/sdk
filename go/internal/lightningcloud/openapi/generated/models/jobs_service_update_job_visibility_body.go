...
func (m *JobsServiceUpdateJobVisibilityBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *JobsServiceUpdateJobVisibilityBody) validateVisibility(formats strfmt.Registry) error {
...
func (m *JobsServiceUpdateJobVisibilityBody) contextValidateVisibility(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JobsServiceUpdateJobVisibilityBody) UnmarshalBinary(b []byte) error {
	var res JobsServiceUpdateJobVisibilityBody
