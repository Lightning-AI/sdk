...
func (m *V1ServiceHealth) validateStatus(formats strfmt.Registry) error {
...
func (m *V1ServiceHealth) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
