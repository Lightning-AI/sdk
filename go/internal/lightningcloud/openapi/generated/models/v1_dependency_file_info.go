...
func (m *V1DependencyFileInfo) validatePackageManager(formats strfmt.Registry) error {
...
func (m *V1DependencyFileInfo) contextValidatePackageManager(ctx context.Context, formats strfmt.Registry) error {
