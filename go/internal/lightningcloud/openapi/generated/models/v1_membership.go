...
// V1Membership Membership is the old name for ProjectMembership, kept for backwards compatibility.
// Plan to use ProjectMembership in all CLI & UI code paths. This will be removed in a future release.
//
...
func (m *V1Membership) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *V1Membership) validateOwnerType(formats strfmt.Registry) error {
...
func (m *V1Membership) validateQuotas(formats strfmt.Registry) error {
...
func (m *V1Membership) validateRoles(formats strfmt.Registry) error {
...
func (m *V1Membership) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *V1Membership) contextValidateOwnerType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1Membership) contextValidateQuotas(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1Membership) contextValidateRoles(ctx context.Context, formats strfmt.Registry) error {
