...
func (m *V1ListCloudSpaceVersionsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ListCloudSpaceVersionsResponse) validateVersions(formats strfmt.Registry) error {
...
func (m *V1ListCloudSpaceVersionsResponse) contextValidateVersions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListCloudSpaceVersionsResponse) UnmarshalBinary(b []byte) error {
	var res V1ListCloudSpaceVersionsResponse
