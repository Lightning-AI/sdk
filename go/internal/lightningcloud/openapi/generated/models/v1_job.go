...
func (m *V1Job) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateReplaceRequestedAt(formats); err != nil {
		res = append(res, err)
	}
...
func (m *V1Job) validateReplaceRequestedAt(formats strfmt.Registry) error {
	if swag.IsZero(m.ReplaceRequestedAt) { // not required
		return nil
	}

	if err := validate.FormatOf("replaceRequestedAt", "body", "date-time", m.ReplaceRequestedAt.String(), formats); err != nil {
		return err
	}
