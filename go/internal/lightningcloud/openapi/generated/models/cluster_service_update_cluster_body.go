...
func (m *ClusterServiceUpdateClusterBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterServiceUpdateClusterBody) validateSpec(formats strfmt.Registry) error {
...
func (m *ClusterServiceUpdateClusterBody) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClusterServiceUpdateClusterBody) UnmarshalBinary(b []byte) error {
	var res ClusterServiceUpdateClusterBody
