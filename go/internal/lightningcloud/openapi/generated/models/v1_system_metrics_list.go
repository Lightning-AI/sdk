...
func (m *V1SystemMetricsList) validateMetrics(formats strfmt.Registry) error {
...
func (m *V1SystemMetricsList) contextValidateMetrics(ctx context.Context, formats strfmt.Registry) error {
