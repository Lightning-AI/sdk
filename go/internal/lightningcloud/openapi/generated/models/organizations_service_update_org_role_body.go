...
func (m *OrganizationsServiceUpdateOrgRoleBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrganizationsServiceUpdateOrgRoleBody) validateRules(formats strfmt.Registry) error {
...
func (m *OrganizationsServiceUpdateOrgRoleBody) contextValidateRules(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrganizationsServiceUpdateOrgRoleBody) UnmarshalBinary(b []byte) error {
	var res OrganizationsServiceUpdateOrgRoleBody
