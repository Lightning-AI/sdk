...
func (m *V1ListDeploymentEventsResponse) validateEvents(formats strfmt.Registry) error {
...
func (m *V1ListDeploymentEventsResponse) contextValidateEvents(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListDeploymentEventsResponse) UnmarshalBinary(b []byte) error {
	var res V1ListDeploymentEventsResponse
