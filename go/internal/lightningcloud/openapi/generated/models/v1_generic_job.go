...
func (m *V1GenericJob) validateTags(formats strfmt.Registry) error {
...
func (m *V1GenericJob) contextValidateTags(ctx context.Context, formats strfmt.Registry) error {
