...
func (m *V1GetCloudSpaceTransferEstimateResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this v1 get cloud space transfer estimate response based on context it is used
func (m *V1GetCloudSpaceTransferEstimateResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
...
func (m *V1GetCloudSpaceTransferEstimateResponse) UnmarshalBinary(b []byte) error {
	var res V1GetCloudSpaceTransferEstimateResponse
