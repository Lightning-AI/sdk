...
func init() {
	...
	if err := json.Unmarshal([]byte(`["SECRET_TYPE_UNSPECIFIED","SECRET_TYPE_DOCKER_REGISTRY","SECRET_TYPE_GCP_CREDENTIALS","SECRET_TYPE_SNOWFLAKE_CREDENTIALS","SECRET_TYPE_R2_CREDENTIALS","SECRET_TYPE_ACCESS_CREDENTIALS","SECRET_TYPE_SSH_PRIVATE_KEY","SECRET_TYPE_HF_TOKEN"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
