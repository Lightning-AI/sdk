...
func (m *ClusterServiceCreateMachineBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterServiceCreateMachineBody) validateBootstrap(formats strfmt.Registry) error {
...
func (m *ClusterServiceCreateMachineBody) validateEnv(formats strfmt.Registry) error {
...
func (m *ClusterServiceCreateMachineBody) validateResources(formats strfmt.Registry) error {
...
func (m *ClusterServiceCreateMachineBody) contextValidateBootstrap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClusterServiceCreateMachineBody) contextValidateEnv(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClusterServiceCreateMachineBody) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClusterServiceCreateMachineBody) UnmarshalBinary(b []byte) error {
	var res ClusterServiceCreateMachineBody
