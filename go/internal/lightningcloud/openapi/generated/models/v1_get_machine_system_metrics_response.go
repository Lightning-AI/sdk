...
func (m *V1GetMachineSystemMetricsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1GetMachineSystemMetricsResponse) validateMetrics(formats strfmt.Registry) error {
...
func (m *V1GetMachineSystemMetricsResponse) contextValidateMetrics(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1GetMachineSystemMetricsResponse) UnmarshalBinary(b []byte) error {
	var res V1GetMachineSystemMetricsResponse
