...
func (m *V1JobLogsResponse) validatePages(formats strfmt.Registry) error {
...
func (m *V1JobLogsResponse) contextValidatePages(ctx context.Context, formats strfmt.Registry) error {
