...
func (m *V1CloudSpacePublication) validateType(formats strfmt.Registry) error {
...
func (m *V1CloudSpacePublication) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1CloudSpacePublication) UnmarshalBinary(b []byte) error {
	var res V1CloudSpacePublication
