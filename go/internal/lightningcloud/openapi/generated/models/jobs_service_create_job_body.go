...
func (m *JobsServiceCreateJobBody) validateEndpoint(formats strfmt.Registry) error {
...
func (m *JobsServiceCreateJobBody) validateSpec(formats strfmt.Registry) error {
...
func (m *JobsServiceCreateJobBody) contextValidateEndpoint(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JobsServiceCreateJobBody) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *JobsServiceCreateJobBody) UnmarshalBinary(b []byte) error {
	var res JobsServiceCreateJobBody
