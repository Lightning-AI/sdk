...
func (m *V1ListOrgRolesResponse) validateRoles(formats strfmt.Registry) error {
...
func (m *V1ListOrgRolesResponse) contextValidateRoles(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListOrgRolesResponse) UnmarshalBinary(b []byte) error {
	var res V1ListOrgRolesResponse
