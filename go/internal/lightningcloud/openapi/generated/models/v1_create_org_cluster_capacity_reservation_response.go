...
func (m *V1CreateOrgClusterCapacityReservationResponse) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this v1 create org cluster capacity reservation response based on context it is used
func (m *V1CreateOrgClusterCapacityReservationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *V1CreateOrgClusterCapacityReservationResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1CreateOrgClusterCapacityReservationResponse) UnmarshalBinary(b []byte) error {
	var res V1CreateOrgClusterCapacityReservationResponse
