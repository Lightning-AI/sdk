...
func (m *V1ListProjectClusterBindingsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1ListProjectClusterBindingsResponse) validateClusters(formats strfmt.Registry) error {
...
func (m *V1ListProjectClusterBindingsResponse) contextValidateClusters(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListProjectClusterBindingsResponse) UnmarshalBinary(b []byte) error {
	var res V1ListProjectClusterBindingsResponse
