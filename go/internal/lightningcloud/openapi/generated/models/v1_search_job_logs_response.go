...
func (m *V1SearchJobLogsResponse) validateEntries(formats strfmt.Registry) error {
...
func (m *V1SearchJobLogsResponse) contextValidateEntries(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1SearchJobLogsResponse) UnmarshalBinary(b []byte) error {
	var res V1SearchJobLogsResponse
