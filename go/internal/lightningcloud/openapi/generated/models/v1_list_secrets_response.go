...
func (m *V1ListSecretsResponse) validateSecrets(formats strfmt.Registry) error {
...
func (m *V1ListSecretsResponse) contextValidateSecrets(ctx context.Context, formats strfmt.Registry) error {
