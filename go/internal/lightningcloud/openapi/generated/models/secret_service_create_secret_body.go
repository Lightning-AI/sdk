...
func (m *SecretServiceCreateSecretBody) validateType(formats strfmt.Registry) error {
...
func (m *SecretServiceCreateSecretBody) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecretServiceCreateSecretBody) UnmarshalBinary(b []byte) error {
	var res SecretServiceCreateSecretBody
