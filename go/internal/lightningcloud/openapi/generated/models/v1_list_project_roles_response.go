...
func (m *V1ListProjectRolesResponse) validateRoles(formats strfmt.Registry) error {
...
func (m *V1ListProjectRolesResponse) contextValidateRoles(ctx context.Context, formats strfmt.Registry) error {
...
func (m *V1ListProjectRolesResponse) UnmarshalBinary(b []byte) error {
	var res V1ListProjectRolesResponse
