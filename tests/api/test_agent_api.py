...
def test_delete_agent(internal_agents_api_delete_agent_mocker):
    agent_api = AgentApi()
    agent_api.delete_agent("ag-abc", "ts-abc")


def test_update_agent(internal_agents_api_update_agent_mocker, internal_agents_api_get_agent_mocker):
    agent_api = AgentApi()
...
def test_update_endpoint(
    internal_agents_api_update_agent_endpoint_mocker, internal_agents_api_get_agent_endpoint_mocker
):
    agent_api = AgentApi()
...
def test_get_agent_endpoint(internal_agents_api_get_agent_endpoint_mocker):
    agent_api = AgentApi()
