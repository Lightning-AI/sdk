...
from lightning_sdk.cli.mmt.ssh import ssh_impl, ssh_mmt
...
def test_ssh_resolves_before_downloading_keys() -> None:
    ...
    with patch(
        ...
        "lightning_sdk.cli.mmt.ssh.exec_ssh",
        exec_mock,
...
def test_ssh_rejects_non_running_machine() -> None:
    ...
    ), patch("lightning_sdk.cli.mmt.ssh.exec_ssh") as exec_mock, pytest.raises(
...
def test_ssh_selects_requested_rank() -> None:
    ...
    with patch("lightning_sdk.cli.mmt.ssh.resolve_teamspace", return_value=teamspace), patch(
        "lightning_sdk.cli.mmt.ssh.resolve_mmt", return_value=mmt
    ), patch("lightning_sdk.cli.utils.ssh_connection.configure_ssh_internal", return_value="/tmp/lightning_rsa"), patch(
        "lightning_sdk.cli.utils.ssh_connection.subprocess.run"
    ) as run:
