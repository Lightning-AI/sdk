...
@pytest.mark.parametrize(
    ...
    [
        ...
        (VM.__init__, {"cloud_account", "cloud_provider"}),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("lightning_sdk.cli.vm.create:create_vm", {"--cloud-account", "--cloud-provider"}),
        ("lightning_sdk.cli.vm.start:start_vm", {"--cloud-account", "--cloud-provider"}),
    ],
)
