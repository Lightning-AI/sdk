...
def internal_get_org_api_mocker(mocker):
    ...
    def list_side_effect(self):
        return V1ListOrganizationsResponse(
            [
                V1Organization(display_name="org-abc", name="org-abc", id="org-abc", preferred_cluster="my-preferred-cluster"),
                V1Organization(display_name="org-def", name="org-def", id="org-def", preferred_cluster="my-preferred-cluster"),
                V1Organization(display_name="my-org-name", name="my-org-name", id="my-org-name", preferred_cluster="my-preferred-cluster"),
                V1Organization(display_name="my-orgname", name="my-orgname", id="my-orgname", preferred_cluster="my-preferred-cluster"),
            ]
        )
