    ...
    def __init__(
        ...
        Args:
            ...
            reserve_machines_timeout_minutes: Minutes to keep the machine reserved after the job
                stops. ``None`` or ``0`` releases the machine immediately.
    ...
    def to_proto(
        ...
        if self.num_machines > 1:
            ...
            body = MMTApiV2._create_mmt_body(
                ...
                tags=self.tags,
                reserve_machines_timeout_minutes=self.reserve_machines_timeout_minutes,
            )
            return V1PipelineStep(
                name=self.name,
...
class MMTStep:
    ...
    def __init__(
        ...
        Args:
            ...
            tags: Teamspace tag names to apply to the job. Tags that don't exist in the teamspace
                yet are created, which requires permission to create tags.
            reserve_machines_timeout_minutes: Minutes to keep the machines reserved after the job
                stops. ``None`` or ``0`` releases the machines immediately.
