...
class V1DeploymentStrategy(object):
    ...
    def __init__(self, rolling_update: 'V1RollingUpdateStrategy' =None, type: 'str' =None):  # noqa: E501
        """V1DeploymentStrategy - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def rolling_update(self) -> 'V1RollingUpdateStrategy':
        ...
        :rtype: V1RollingUpdateStrategy
        """
        return self._rolling_update

    @rolling_update.setter
    def rolling_update(self, rolling_update: 'V1RollingUpdateStrategy'):
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1DeploymentStrategy, dict):
    ...
    def __eq__(self, other: 'V1DeploymentStrategy') -> bool:
    ...
    def __ne__(self, other: 'V1DeploymentStrategy') -> bool:
