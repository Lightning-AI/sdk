...
class V1ListCloudSpaceTagsResponse(object):
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ListCloudSpaceTagsResponse, dict):
    ...
    def __eq__(self, other: 'V1ListCloudSpaceTagsResponse') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, V1ListCloudSpaceTagsResponse):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'V1ListCloudSpaceTagsResponse') -> bool:
