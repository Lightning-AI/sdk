...
class V1PodMetrics(object):
    ...
    def per_gpu_tflops_per_second(self) -> 'dict(str, float)':
        """Gets the per_gpu_tflops_per_second of this V1PodMetrics.  # noqa: E501


        :return: The per_gpu_tflops_per_second of this V1PodMetrics.  # noqa: E501
        :rtype: dict(str, float)
        """
    ...
    def per_gpu_tflops_per_second(self, per_gpu_tflops_per_second: 'dict(str, float)'):
        """Sets the per_gpu_tflops_per_second of this V1PodMetrics.


        :param per_gpu_tflops_per_second: The per_gpu_tflops_per_second of this V1PodMetrics.  # noqa: E501
        :type: dict(str, float)
        """
