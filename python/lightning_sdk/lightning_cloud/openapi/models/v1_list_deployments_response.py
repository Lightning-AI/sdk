...
class V1ListDeploymentsResponse(object):
    ...
    def deployments(self) -> 'list[V1Deployment]':
        """Gets the deployments of this V1ListDeploymentsResponse.  # noqa: E501


        :return: The deployments of this V1ListDeploymentsResponse.  # noqa: E501
        :rtype: list[V1Deployment]
        """
        return self._deployments

    @deployments.setter
    def deployments(self, deployments: 'list[V1Deployment]'):
        """Sets the deployments of this V1ListDeploymentsResponse.


        :param deployments: The deployments of this V1ListDeploymentsResponse.  # noqa: E501
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ListDeploymentsResponse, dict):
    ...
    def __eq__(self, other: 'V1ListDeploymentsResponse') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, V1ListDeploymentsResponse):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'V1ListDeploymentsResponse') -> bool:
