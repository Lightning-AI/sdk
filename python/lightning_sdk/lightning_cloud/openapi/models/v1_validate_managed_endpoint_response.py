...
class V1ValidateManagedEndpointResponse(object):
    ...
    def valid(self) -> 'bool':
        ...
        :return: The valid of this V1ValidateManagedEndpointResponse.  # noqa: E501
        :rtype: bool
        """
        return self._valid
    ...
    def valid(self, valid: 'bool'):
        """Sets the valid of this V1ValidateManagedEndpointResponse.


        :param valid: The valid of this V1ValidateManagedEndpointResponse.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ValidateManagedEndpointResponse, dict):
    ...
    def __eq__(self, other: 'V1ValidateManagedEndpointResponse') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, V1ValidateManagedEndpointResponse):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'V1ValidateManagedEndpointResponse') -> bool:
