...
class V1CloudSpaceInstanceState(object):
    ...
    def __init__(self):  # noqa: E501
        """V1CloudSpaceInstanceState - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1CloudSpaceInstanceState, dict):
    ...
    def __eq__(self, other: 'V1CloudSpaceInstanceState') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, V1CloudSpaceInstanceState):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'V1CloudSpaceInstanceState') -> bool:
