...
class AuthServiceApi(object):
    ...
    def auth_service_whoami(self, **kwargs) -> 'V1WhoamiResponse':  # noqa: E501
        """Whoami returns the authenticated caller's identity, for either a personal user key or a scoped API key. For a scoped key it also reports the key's org/project.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.auth_service_whoami(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.auth_service_whoami_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.auth_service_whoami_with_http_info(**kwargs)  # noqa: E501
            return data

    def auth_service_whoami_with_http_info(self, **kwargs) -> 'V1WhoamiResponse':  # noqa: E501
        """Whoami returns the authenticated caller's identity, for either a personal user key or a scoped API key. For a scoped key it also reports the key's org/project.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.auth_service_whoami_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method auth_service_whoami" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='V1WhoamiResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
