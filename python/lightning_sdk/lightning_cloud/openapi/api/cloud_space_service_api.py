...
class CloudSpaceServiceApi(object):
    ...
    def cloud_space_service_report_cloud_space_instance_idle_state(self, project_id: 'str', cloudspace_id: 'str', **kwargs) -> 'V1ReportCloudSpaceInstanceIdleStateResponse':  # noqa: E501
        """cloud_space_service_report_cloud_space_instance_idle_state  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cloud_space_service_report_cloud_space_instance_idle_state(project_id, cloudspace_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: V1ReportCloudSpaceInstanceIdleStateResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cloud_space_service_report_cloud_space_instance_idle_state_with_http_info(project_id, cloudspace_id, **kwargs)  # noqa: E501
        else:
            (data) = self.cloud_space_service_report_cloud_space_instance_idle_state_with_http_info(project_id, cloudspace_id, **kwargs)  # noqa: E501
            return data

    def cloud_space_service_report_cloud_space_instance_idle_state_with_http_info(self, project_id: 'str', cloudspace_id: 'str', **kwargs) -> 'V1ReportCloudSpaceInstanceIdleStateResponse':  # noqa: E501
        """cloud_space_service_report_cloud_space_instance_idle_state  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cloud_space_service_report_cloud_space_instance_idle_state_with_http_info(project_id, cloudspace_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_id', 'cloudspace_id', 'cloudspace_instance_id', 'is_idle', 'timestamp']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cloud_space_service_report_cloud_space_instance_idle_state" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `cloud_space_service_report_cloud_space_instance_idle_state`")  # noqa: E501
        # verify the required parameter 'cloudspace_id' is set
        if ('cloudspace_id' not in params or
                params['cloudspace_id'] is None):
            raise ValueError("Missing the required parameter `cloudspace_id` when calling `cloud_space_service_report_cloud_space_instance_idle_state`")  # noqa: E501
        ...
        if 'cloudspace_instance_id' in params:
            query_params.append(('cloudspaceInstanceId', params['cloudspace_instance_id']))  # noqa: E501
        if 'is_idle' in params:
            query_params.append(('isIdle', params['is_idle']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId}/cloudspaces/{cloudspaceId}/report-idle-state', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1ReportCloudSpaceInstanceIdleStateResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def cloud_space_service_suggest_cloud_space_name(self, body: 'CloudSpaceServiceSuggestCloudSpaceNameBody', project_id: 'str', **kwargs) -> 'V1SuggestCloudSpaceNameResponse':  # noqa: E501
        """cloud_space_service_suggest_cloud_space_name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cloud_space_service_suggest_cloud_space_name(body, project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CloudSpaceServiceSuggestCloudSpaceNameBody body: (required)
        :param str project_id: (required)
        :return: V1SuggestCloudSpaceNameResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cloud_space_service_suggest_cloud_space_name_with_http_info(body, project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.cloud_space_service_suggest_cloud_space_name_with_http_info(body, project_id, **kwargs)  # noqa: E501
            return data

    def cloud_space_service_suggest_cloud_space_name_with_http_info(self, body: 'CloudSpaceServiceSuggestCloudSpaceNameBody', project_id: 'str', **kwargs) -> 'V1SuggestCloudSpaceNameResponse':  # noqa: E501
        """cloud_space_service_suggest_cloud_space_name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cloud_space_service_suggest_cloud_space_name_with_http_info(body, project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cloud_space_service_suggest_cloud_space_name" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `cloud_space_service_suggest_cloud_space_name`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `cloud_space_service_suggest_cloud_space_name`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId}/cloudspaces/suggest-name', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1SuggestCloudSpaceNameResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def cloud_space_service_update_cloud_space_tutorial_shown(self, body: 'CloudSpaceServiceUpdateCloudSpaceTutorialShownBody', project_id: 'str', id: 'str', **kwargs) -> 'V1CloudSpaceInstanceConfig':  # noqa: E501
        """cloud_space_service_update_cloud_space_tutorial_shown  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cloud_space_service_update_cloud_space_tutorial_shown(body, project_id, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CloudSpaceServiceUpdateCloudSpaceTutorialShownBody body: (required)
        :param str project_id: (required)
        :param str id: (required)
        :return: V1CloudSpaceInstanceConfig
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cloud_space_service_update_cloud_space_tutorial_shown_with_http_info(body, project_id, id, **kwargs)  # noqa: E501
        else:
            (data) = self.cloud_space_service_update_cloud_space_tutorial_shown_with_http_info(body, project_id, id, **kwargs)  # noqa: E501
            return data

    def cloud_space_service_update_cloud_space_tutorial_shown_with_http_info(self, body: 'CloudSpaceServiceUpdateCloudSpaceTutorialShownBody', project_id: 'str', id: 'str', **kwargs) -> 'V1CloudSpaceInstanceConfig':  # noqa: E501
        """cloud_space_service_update_cloud_space_tutorial_shown  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cloud_space_service_update_cloud_space_tutorial_shown_with_http_info(body, project_id, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method cloud_space_service_update_cloud_space_tutorial_shown" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `cloud_space_service_update_cloud_space_tutorial_shown`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `cloud_space_service_update_cloud_space_tutorial_shown`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `cloud_space_service_update_cloud_space_tutorial_shown`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId}/cloudspaces/{id}/tutorial-shown', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
