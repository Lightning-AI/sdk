...
class AssistantsServiceApi(object):
    ...
    def assistants_service_list_user_conversations(self, user_id: 'str', **kwargs) -> 'V1ListConversationsResponse':  # noqa: E501
        """assistants_service_list_user_conversations  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.assistants_service_list_user_conversations(user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str user_id: Filter conversations by user ID (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.assistants_service_list_user_conversations_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.assistants_service_list_user_conversations_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def assistants_service_list_user_conversations_with_http_info(self, user_id: 'str', **kwargs) -> 'V1ListConversationsResponse':  # noqa: E501
        """assistants_service_list_user_conversations  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.assistants_service_list_user_conversations_with_http_info(user_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method assistants_service_list_user_conversations" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('user_id' not in params or
            ...
            raise ValueError("Missing the required parameter `user_id` when calling `assistants_service_list_user_conversations`")  # noqa: E501
        ...
        query_params = []
        if 'assistant_id' in params:
            query_params.append(('assistantId', params['assistant_id']))  # noqa: E501
        if 'page_token' in params:
            query_params.append(('pageToken', params['page_token']))  # noqa: E501
        if 'filter_internal' in params:
            query_params.append(('filterInternal', params['filter_internal']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/users/{userId}/agents/conversations', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def assistants_service_publish_community_model(self, body: 'V1PublishCommunityModelRequest', **kwargs) -> 'V1ManagedModel':  # noqa: E501
        """PublishCommunityModel onboards a model into the public Model API catalog. Requires internal_model_apis_admin.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.assistants_service_publish_community_model(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1PublishCommunityModelRequest body: PublishCommunityModelRequest onboards a model into the community Model API catalog. (required)
        :return: V1ManagedModel
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.assistants_service_publish_community_model_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.assistants_service_publish_community_model_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def assistants_service_publish_community_model_with_http_info(self, body: 'V1PublishCommunityModelRequest', **kwargs) -> 'V1ManagedModel':  # noqa: E501
        """PublishCommunityModel onboards a model into the public Model API catalog. Requires internal_model_apis_admin.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.assistants_service_publish_community_model_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method assistants_service_publish_community_model" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `assistants_service_publish_community_model`")  # noqa: E501
