...
class ModelsStoreApi(object):
    ...
    def models_store_get_model_routing_table(self, **kwargs) -> 'V1GetModelRoutingTableResponse':  # noqa: E501
        """Worker-gated: returns the full model-name → deployment-domain mapping. Used by the unified CF proxy worker to resolve model APIs to deployment hostnames without one-by-one lookups.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.models_store_get_model_routing_table(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: V1GetModelRoutingTableResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.models_store_get_model_routing_table_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.models_store_get_model_routing_table_with_http_info(**kwargs)  # noqa: E501
            return data

    def models_store_get_model_routing_table_with_http_info(self, **kwargs) -> 'V1GetModelRoutingTableResponse':  # noqa: E501
        """Worker-gated: returns the full model-name → deployment-domain mapping. Used by the unified CF proxy worker to resolve model APIs to deployment hostnames without one-by-one lookups.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.models_store_get_model_routing_table_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method models_store_get_model_routing_table" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='V1GetModelRoutingTableResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
