...
class LitLoggerServiceApi(object):
    ...
    def lit_logger_service_get_logger_metrics_summary(self, project_id: 'str', **kwargs) -> 'V1GetLoggerMetricsSummaryResponse':  # noqa: E501
        """lit_logger_service_get_logger_metrics_summary  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lit_logger_service_get_logger_metrics_summary(project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str project_id: (required)
        :param list[str] ids:
        :return: V1GetLoggerMetricsSummaryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.lit_logger_service_get_logger_metrics_summary_with_http_info(project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.lit_logger_service_get_logger_metrics_summary_with_http_info(project_id, **kwargs)  # noqa: E501
            return data

    def lit_logger_service_get_logger_metrics_summary_with_http_info(self, project_id: 'str', **kwargs) -> 'V1GetLoggerMetricsSummaryResponse':  # noqa: E501
        """lit_logger_service_get_logger_metrics_summary  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lit_logger_service_get_logger_metrics_summary_with_http_info(project_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_id', 'ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method lit_logger_service_get_logger_metrics_summary" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `lit_logger_service_get_logger_metrics_summary`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId}/logger-metrics-summary', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1GetLoggerMetricsSummaryResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def lit_logger_service_list_all_metrics_streams(self, **kwargs) -> 'V1ListMetricsStreamsResponse':  # noqa: E501
        ...
        :param list[str] job_ids: filter by specific job IDs
    ...
    def lit_logger_service_list_all_metrics_streams_with_http_info(self, **kwargs) -> 'V1ListMetricsStreamsResponse':  # noqa: E501
        ...
        all_params = ['user_ids', 'org_id', 'project_id', 'cloud_space_id', 'app_id', 'limit', 'offset', 'order_by', 'ids', 'job_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def lit_logger_service_list_metrics_streams_with_http_info(self, project_id: 'str', **kwargs) -> 'V1ListMetricsStreamsResponse':  # noqa: E501
        ...
        all_params = ['project_id', 'user_ids', 'cloud_space_id', 'app_id', 'limit', 'offset', 'order_by', 'ids', 'job_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
