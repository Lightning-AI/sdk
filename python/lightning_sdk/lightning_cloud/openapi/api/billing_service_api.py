...
class BillingServiceApi(object):
    ...
    def billing_service_get_account_balance(self, **kwargs) -> 'V1GetAccountBalanceResponse':  # noqa: E501
        """billing_service_get_account_balance  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_account_balance(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: V1GetAccountBalanceResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.billing_service_get_account_balance_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.billing_service_get_account_balance_with_http_info(**kwargs)  # noqa: E501
            return data

    def billing_service_get_account_balance_with_http_info(self, **kwargs) -> 'V1GetAccountBalanceResponse':  # noqa: E501
        """billing_service_get_account_balance  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_account_balance_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method billing_service_get_account_balance" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/v1/billing/account-balance', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1GetAccountBalanceResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def billing_service_get_inference_rate_limit(self, **kwargs) -> 'V1GetInferenceRateLimitResponse':  # noqa: E501
        """billing_service_get_inference_rate_limit  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_inference_rate_limit(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: V1GetInferenceRateLimitResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.billing_service_get_inference_rate_limit_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.billing_service_get_inference_rate_limit_with_http_info(**kwargs)  # noqa: E501
            return data

    def billing_service_get_inference_rate_limit_with_http_info(self, **kwargs) -> 'V1GetInferenceRateLimitResponse':  # noqa: E501
        """billing_service_get_inference_rate_limit  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_inference_rate_limit_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method billing_service_get_inference_rate_limit" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/v1/billing/inference-rate-limit', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1GetInferenceRateLimitResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def billing_service_get_monthly_summary(self, **kwargs) -> 'V1GetMonthlySummaryResponse':  # noqa: E501
        """billing_service_get_monthly_summary  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_monthly_summary(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str org_id: string since GetBillingSubscriptionRequest uses a string for org_id
        :param str time_filter_pivot_filter_pivot_direction:
        :param datetime time_filter_pivot_filter_pivot:
        :param datetime time_filter_range_filter_range_start:
        :param datetime time_filter_range_filter_range_end:
        :return: V1GetMonthlySummaryResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.billing_service_get_monthly_summary_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.billing_service_get_monthly_summary_with_http_info(**kwargs)  # noqa: E501
            return data

    def billing_service_get_monthly_summary_with_http_info(self, **kwargs) -> 'V1GetMonthlySummaryResponse':  # noqa: E501
        """billing_service_get_monthly_summary  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_monthly_summary_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org_id', 'time_filter_pivot_filter_pivot_direction', 'time_filter_pivot_filter_pivot', 'time_filter_range_filter_range_start', 'time_filter_range_filter_range_end']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method billing_service_get_monthly_summary" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'org_id' in params:
            query_params.append(('orgId', params['org_id']))  # noqa: E501
        if 'time_filter_pivot_filter_pivot_direction' in params:
            query_params.append(('timeFilter.pivotFilter.pivotDirection', params['time_filter_pivot_filter_pivot_direction']))  # noqa: E501
        if 'time_filter_pivot_filter_pivot' in params:
            query_params.append(('timeFilter.pivotFilter.pivot', params['time_filter_pivot_filter_pivot']))  # noqa: E501
        if 'time_filter_range_filter_range_start' in params:
            query_params.append(('timeFilter.rangeFilter.rangeStart', params['time_filter_range_filter_range_start']))  # noqa: E501
        if 'time_filter_range_filter_range_end' in params:
            query_params.append(('timeFilter.rangeFilter.rangeEnd', params['time_filter_range_filter_range_end']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/billing/monthly-summary', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1GetMonthlySummaryResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def billing_service_get_sandbox_usage_activity(self, **kwargs) -> 'V1GetSandboxUsageActivityResponse':  # noqa: E501
        """Sandbox billing intervals from ClickHouse: active count, cost, and runtime per time bucket.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_sandbox_usage_activity(async_req=True)
        >>> result = thread.get()
        ...
        :param datetime _from:
        :param datetime to:
        :param str user_id: Optional filter to scope metrics to a single user.
        :return: V1GetSandboxUsageActivityResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.billing_service_get_sandbox_usage_activity_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.billing_service_get_sandbox_usage_activity_with_http_info(**kwargs)  # noqa: E501
            return data

    def billing_service_get_sandbox_usage_activity_with_http_info(self, **kwargs) -> 'V1GetSandboxUsageActivityResponse':  # noqa: E501
        """Sandbox billing intervals from ClickHouse: active count, cost, and runtime per time bucket.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_sandbox_usage_activity_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org_id', 'project_id', '_from', 'to', 'user_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method billing_service_get_sandbox_usage_activity" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/v1/billing/sandbox-usage/activity', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1GetSandboxUsageActivityResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def billing_service_get_usage_report_v1(self, **kwargs) -> 'V1UsageReportV1':  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_usage_report_v1(async_req=True)
        >>> result = thread.get()
        ...
        :param str user_id: Optional, will filter by a user's activity in the daily rollup billing activity endpoint
        ...
        :return: V1UsageReportV1
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.billing_service_get_usage_report_v1_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.billing_service_get_usage_report_v1_with_http_info(**kwargs)  # noqa: E501
            return data

    def billing_service_get_usage_report_v1_with_http_info(self, **kwargs) -> 'V1UsageReportV1':  # noqa: E501
        """Usage report endpoint to get credits spending information. Provides credits consumption data by particular project according to filters given.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_usage_report_v1_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method billing_service_get_usage_report_v1" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='V1UsageReportV1',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def billing_service_get_usage_report_v2(self, **kwargs) -> 'V1UsageReportV2':  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_usage_report_v2(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str org_id:
        :param list[str] project_ids: Optional, if not specified, will show activity over all projects in org
        :param list[str] resource_types: Optional, if not specified, all resource types will be returned
        :param list[str] resource_ids: Optional, if not specified, all filtered resources will be returned
        :param list[str] user_ids: Optional, will filter by users' activity in the daily rollup billing activity endpoint
        :param datetime _from: Optional, if not specified, we take the project creation / resource creation time
        :param datetime to: Optional, if not specified, we take the resource deletion time or the current date
        :param int limit: Optional, max number of entries to return. The UI will always send a limit to ensure we don't crash the grpc client.
        :param datetime search_after: Optional, only include usage entries strictly after this time. This time will be the time of the last returned usage report item. The API will return the next search_after to use.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.billing_service_get_usage_report_v2_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.billing_service_get_usage_report_v2_with_http_info(**kwargs)  # noqa: E501
            return data

    def billing_service_get_usage_report_v2_with_http_info(self, **kwargs) -> 'V1UsageReportV2':  # noqa: E501
        """V2 Usage report endpoint to get credits spending information. Provides credits consumption data by particular project according to filters given. Uses the new daily rollup table  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_get_usage_report_v2_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method billing_service_get_usage_report_v2" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/v1/billing/usage-report-rollup', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1UsageReportV2',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def billing_service_report_inference_usage(self, body: 'V1ReportInferenceUsageRequest', **kwargs) -> 'V1ReportInferenceUsageResponse':  # noqa: E501
        """billing_service_report_inference_usage  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_report_inference_usage(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param V1ReportInferenceUsageRequest body: (required)
        :return: V1ReportInferenceUsageResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.billing_service_report_inference_usage_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.billing_service_report_inference_usage_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def billing_service_report_inference_usage_with_http_info(self, body: 'V1ReportInferenceUsageRequest', **kwargs) -> 'V1ReportInferenceUsageResponse':  # noqa: E501
        """billing_service_report_inference_usage  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.billing_service_report_inference_usage_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method billing_service_report_inference_usage" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `billing_service_report_inference_usage`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/billing/inference-usage', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1ReportInferenceUsageResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
