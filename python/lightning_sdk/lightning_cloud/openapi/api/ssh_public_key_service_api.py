...
class SSHPublicKeyServiceApi(object):
    ...
    def s_sh_public_key_service_get_ssh_setup_url(self, **kwargs) -> 'V1GetSSHSetupURLResponse':  # noqa: E501
        """Mints the short-lived user token the SSH setup scripts are fetched with.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.s_sh_public_key_service_get_ssh_setup_url(async_req=True)
        >>> result = thread.get()
        ...
        :return: V1GetSSHSetupURLResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.s_sh_public_key_service_get_ssh_setup_url_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.s_sh_public_key_service_get_ssh_setup_url_with_http_info(**kwargs)  # noqa: E501
            return data

    def s_sh_public_key_service_get_ssh_setup_url_with_http_info(self, **kwargs) -> 'V1GetSSHSetupURLResponse':  # noqa: E501
        """Mints the short-lived user token the SSH setup scripts are fetched with.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.s_sh_public_key_service_get_ssh_setup_url_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['cloudspace_id', 'cluster_id', 'machine_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method s_sh_public_key_service_get_ssh_setup_url" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='V1GetSSHSetupURLResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
