...
class UserServiceApi(object):
    ...
    def user_service_opt_in_early_migration(self, body: 'UserServiceOptInEarlyMigrationBody', user_id: 'str', **kwargs) -> 'V1OptInEarlyMigrationResponse':  # noqa: E501
        """user_service_opt_in_early_migration  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_service_opt_in_early_migration(body, user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UserServiceOptInEarlyMigrationBody body: (required)
        :param str user_id: (required)
        :return: V1OptInEarlyMigrationResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_service_opt_in_early_migration_with_http_info(body, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.user_service_opt_in_early_migration_with_http_info(body, user_id, **kwargs)  # noqa: E501
            return data

    def user_service_opt_in_early_migration_with_http_info(self, body: 'UserServiceOptInEarlyMigrationBody', user_id: 'str', **kwargs) -> 'V1OptInEarlyMigrationResponse':  # noqa: E501
        """user_service_opt_in_early_migration  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_service_opt_in_early_migration_with_http_info(body, user_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method user_service_opt_in_early_migration" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `user_service_opt_in_early_migration`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `user_service_opt_in_early_migration`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/users/{userId}/early-migration-optin', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1OptInEarlyMigrationResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
