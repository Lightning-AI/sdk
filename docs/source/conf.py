...
spec = spec_from_file_location("lightning_sdk/__init__.py", os.path.join(_PATH_SOURCE, "lightning_sdk", "__init__.py"))
...
author = "Lightning AI"
copyright = f"Copyright (c) 2020-2023, {author}."
...
html_theme_options = {
    ...
    "canonical_url": "https://lightning.ai",
