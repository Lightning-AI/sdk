...
class LitLoggerServiceApi(object):
    ...
    def lit_logger_service_list_metrics_streams(self, body: 'MetricsstreamListBody', project_id: 'str', **kwargs) -> 'V1ListMetricsStreamsResponse':  # noqa: E501
        """lit_logger_service_list_metrics_streams  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lit_logger_service_list_metrics_streams(body, project_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param MetricsstreamListBody body: (required)
        :param str project_id: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.lit_logger_service_list_metrics_streams_with_http_info(body, project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.lit_logger_service_list_metrics_streams_with_http_info(body, project_id, **kwargs)  # noqa: E501
            return data

    def lit_logger_service_list_metrics_streams_with_http_info(self, body: 'MetricsstreamListBody', project_id: 'str', **kwargs) -> 'V1ListMetricsStreamsResponse':  # noqa: E501
        """lit_logger_service_list_metrics_streams  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.lit_logger_service_list_metrics_streams_with_http_info(body, project_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `lit_logger_service_list_metrics_streams`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
        ...
        return self.api_client.call_api(
            '/v1/projects/{projectId}/metrics-stream/list', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
