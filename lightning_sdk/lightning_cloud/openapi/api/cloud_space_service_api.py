...
class CloudSpaceServiceApi(object):
    ...
    def cloud_space_service_create_cloud_space_session(self, body: 'object', project_id: 'str', cloudspace_id: 'str', **kwargs) -> 'V1CloudSpaceSession':  # noqa: E501
        """cloud_space_service_create_cloud_space_session  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cloud_space_service_create_cloud_space_session(body, project_id, cloudspace_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.cloud_space_service_create_cloud_space_session_with_http_info(body, project_id, cloudspace_id, **kwargs)  # noqa: E501
        else:
            (data) = self.cloud_space_service_create_cloud_space_session_with_http_info(body, project_id, cloudspace_id, **kwargs)  # noqa: E501
            return data

    def cloud_space_service_create_cloud_space_session_with_http_info(self, body: 'object', project_id: 'str', cloudspace_id: 'str', **kwargs) -> 'V1CloudSpaceSession':  # noqa: E501
        """cloud_space_service_create_cloud_space_session  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.cloud_space_service_create_cloud_space_session_with_http_info(body, project_id, cloudspace_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `cloud_space_service_create_cloud_space_session`")  # noqa: E501
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
