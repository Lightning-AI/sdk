...
class AgentServiceApi(object):
    ...
    def agent_service_upload_agent_job_logs(self, body: 'object', id: 'str', **kwargs) -> 'V1UploadAgentJobLogsResponse':  # noqa: E501
        """agent_service_upload_agent_job_logs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.agent_service_upload_agent_job_logs(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object body: (required)
        :param str id: (required)
        :return: V1UploadAgentJobLogsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.agent_service_upload_agent_job_logs_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.agent_service_upload_agent_job_logs_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def agent_service_upload_agent_job_logs_with_http_info(self, body: 'object', id: 'str', **kwargs) -> 'V1UploadAgentJobLogsResponse':  # noqa: E501
        """agent_service_upload_agent_job_logs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.agent_service_upload_agent_job_logs_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method agent_service_upload_agent_job_logs" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `agent_service_upload_agent_job_logs`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `agent_service_upload_agent_job_logs`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='V1UploadAgentJobLogsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def agent_service_upload_agent_job_output(self, body: 'object', id: 'str', **kwargs) -> 'V1UploadAgentJobOutputResponse':  # noqa: E501
        """agent_service_upload_agent_job_output  # noqa: E501
    ...
    def agent_service_upload_agent_job_output_with_http_info(self, body: 'object', id: 'str', **kwargs) -> 'V1UploadAgentJobOutputResponse':  # noqa: E501
        """agent_service_upload_agent_job_output  # noqa: E501
