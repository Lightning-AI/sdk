...
class V1ListModelsResponse(object):
    ...
    def models(self) -> 'list[V1Model]':
        """Gets the models of this V1ListModelsResponse.  # noqa: E501


        :return: The models of this V1ListModelsResponse.  # noqa: E501
        :rtype: list[V1Model]
        """
        return self._models

    @models.setter
    def models(self, models: 'list[V1Model]'):
        """Sets the models of this V1ListModelsResponse.


        :param models: The models of this V1ListModelsResponse.  # noqa: E501
        :type: list[V1Model]
        """
    ...
    def to_dict(self) -> dict:
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1ListModelsResponse, dict):
    ...
    def __eq__(self, other: 'V1ListModelsResponse') -> bool:
        """Returns true if both objects are equal"""
        if not isinstance(other, V1ListModelsResponse):
            return False

        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'V1ListModelsResponse') -> bool:
